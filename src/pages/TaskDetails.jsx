...
const TaskDetails = () => {
  ...
  return (
    <div className="w-full flex flex-col gab-3 mb-4 overflow-y-hidden">
      <h1 className="text-2xl text-gray-600 font-bold">{task?.title}</h1>

      <Tabs tabs={TABS} setSelected={setSelected}>
        {selected === 0 ? (
          <>
            <div className="w-full flex flex-col md:flex-row gap-5 2xl: gab-8 bg-white shadow-md px-8 p-8 overflow-y-auto">
              {/* LEFT */}
                ...
                <div className="space-y-4 py-6">
                  ...
                  <div className="space-y-8">
                    {task?.subTasks?.map((el, index) => (
                      <div key={index} className="flew gap-3">
